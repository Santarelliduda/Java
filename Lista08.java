	...
	public static void main(String[] args) {
		...
		// 1 - Classificação de Dia da Semana
	     ...
	     // 3 - Tipo de Veículo
	        ...
	        // 6 - Tipo de Ingresso 
	        System.out.println("\nDigite o código do ingresso (1=Inteira, 2=Meia, 3=VIP): ");
	     ...
	     // 8 - Nível de Acesso
	        System.out.println("\nDigite o nível de acesso (1=Usuário, 2=Moderador, 3=Administrador): ");
	        ...
	        // 9 - Tipo de Pagamento 
	        System.out.println("\nDigite o código do pagamento (1=Dinheiro, 2=Cartão de Crédito, 3=Pix): ");
